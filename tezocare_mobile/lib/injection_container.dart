...
void _initVisit() {
  ...
  sl.registerFactory(() => VisitBloc(
        ...
        getPatientVisitsUseCase: sl(),
        getVisitDetailUseCase: sl(),
      ));
}
...
void _initMedication() {
  ...
  sl.registerFactory(() => MedicationBloc(
        ...
        getPatientMedicationsUseCase: sl(),
        updateMedicationUseCase: sl(),
        deactivateMedicationUseCase: sl(),
      ));
}
